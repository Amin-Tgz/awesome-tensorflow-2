...
To create your own list, check out the [instructions](https://github.com/sindresorhus/awesome).
...
1. Go to [main page](https://github.com/Amin-Tgz/Awesome-TensorFlow-2) 
